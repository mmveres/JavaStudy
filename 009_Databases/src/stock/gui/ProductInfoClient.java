...
public class ProductInfoClient extends JDialog {
	...
	protected void addProduct() {
		try {
			...
			Product product = new Product(Integer.parseInt(txtId.getText()), txtDescription.getText(),
					Float.parseFloat(txtRate.getText()), Integer.parseInt(txtQuantity.getText()));
